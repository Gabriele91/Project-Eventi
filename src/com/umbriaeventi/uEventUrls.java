...
public class uEventUrls {
	...
	public static final String serverCitiesLink="http://umbriaeventi.herokuapp.com/cities?region=";
	...
	static public String[] getCities(String region){			
		if(cities==null){
			String linkRegion=region.replace(" ", "%20");
	    	String pageString=getWebPageString(serverCitiesLink+linkRegion);
